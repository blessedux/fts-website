        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 mt-12">
          <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-md bg-[#25D366]  px-4 py-2 text-sm font-medium text-white shadow transition-colors hover:bg-[#128C7E] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#25D366] disabled:pointer-events-none disabled:opacity-50"
            >
              <svg
          ...
          <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
            ...
            <h3 className="text-xl font-bold">Talleres Presenciales</h3>
            <ul className="text-center text-sm text-gray-500 dark:text-gray-400 space-y-1">
